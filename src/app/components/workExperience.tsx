...
export default function workExperience() {
  ...
  return (
    <div className="mt-16">
      <motion.h3 initial={{opacity : 0, y : 100}} whileInView={{opacity : 1, y: 0}} transition={{delay: 0.1}} viewport={{once : true}} className="text-2xl font-bold">Work Experience 💼</motion.h3>
      {workExperiences.map((item, index) => (
        <motion.div initial={{opacity : 0, y : 100}} whileInView={{opacity : 1, y: 0}} transition={{delay: 0.2}} viewport={{once : true}}  className="w-full mt-6" key={index}>
